...
class ClassificationLayer(OutputLayer):
    ...
    def update_weights(self, 
                       input: torch.Tensor, 
                       output: torch.Tensor, 
                       clamped_output: torch.Tensor = None) -> None:
        """
        METHOD
    ...
    def _train_forward(self, 
        ...
        """
        METHOD
        Defines how an input data flows through the classification layer when training
        This means the classification layer weights must be updating
    ...
    def _eval_forward(self, 
        ...
        """
        METHOD
        Defines how an input data flows through the classification layer when testing
        This means the classification layer weights cannot be updated 
        @param
            input: input data into the layer
        @return
